...
#sudo apt-get install imagemagick  #v0.2 varias imagenes a pdf  #convert images.jpeg png.png tux.jpg imagenes.pdf
...
# sudo pip install PyPDF2 para MODO CARPETA #v0.2 varios pdf a uno solo   #https://steemit.com/spanish/@sethroot/el-poder-de-python-pegar-varios-pdfs-en-1-solo-pdf-learning


#Utiliza ventana para seleccionar archivos
#Un menu para convertir:
...
def ModoSelect():
    ### funciona bien pero falta seleccionar donde guardar el archivo resultado
    ### para evitar la funcion os.getcwd()
    merger = PdfFileMerger()
    ...
    #Selecciona donde guardar el resultado
    directorio = os.getcwd() #directorio actual de script
    #raw_input("Pulsa una tecla para continuar...")   
...
while True:
    ...
    if opt_menu == "2":
        ...
        ModoSelect()
        directorio = os.getcwd() #directorio actual de script
        print "El archivo RESOLUCION.pdf fue guardado en :"+directorio
        raw_input("Pulsa una tecla para continuar...")
